...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.WebhooksApi();
  });
  ...
  describe('WebhooksApi', function() {
    ...
    describe('getWebhookEvents', function() {
      it('should call getWebhookEvents successfully', function(done) {
        //uncomment below and update the code to test getWebhookEvents
        //instance.getWebhookEvents(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
