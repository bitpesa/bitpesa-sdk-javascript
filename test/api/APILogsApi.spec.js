...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.APILogsApi();
  });
  ...
  describe('APILogsApi', function() {
    describe('getApiLog', function() {
      it('should call getApiLog successfully', function(done) {
        //uncomment below and update the code to test getApiLog
        //instance.getApiLog(function(error) {
