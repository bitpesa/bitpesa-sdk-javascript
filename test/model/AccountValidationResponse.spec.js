...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitpesaSdk.AccountValidationResponse();
  });
  ...
  describe('AccountValidationResponse', function() {
    it('should create an instance of AccountValidationResponse', function() {
      ...
      //var instane = new BitpesaSdk.AccountValidationResponse();
      //expect(instance).to.be.a(BitpesaSdk.AccountValidationResponse);
    });
