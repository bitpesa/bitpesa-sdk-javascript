...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitpesaSdk.SenderResponseExisting();
  });
  ...
  describe('SenderResponseExisting', function() {
    it('should create an instance of SenderResponseExisting', function() {
      ...
      //var instane = new BitpesaSdk.SenderResponseExisting();
      //expect(instance).to.be.a(BitpesaSdk.SenderResponseExisting);
    });
